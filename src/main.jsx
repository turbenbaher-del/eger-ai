...
import 'firebase/compat/functions';
  ...
  firebase.initializeApp({
    ...
    authDomain:"eger-ai.firebaseapp.com", projectId:"eger-ai",
  ...
  let _analytics; try{_analytics=firebase.analytics();}catch(e){}
  const logEvent=(name,params={})=>{try{_analytics&&_analytics.logEvent(name,params);}catch(e){}};
  const VAPID_KEY = 'BP9Ol8dxGFtYScy7kqla61Pfkf7ek-o3Qi08TofmzNV_kFCziFQXouSzPYkHPOo-7-x_eC7zEKUPq103NOOZaDg';

  /* ── Icons ── */
  const ic = (paths, extra={}) => ({ size=24, color='currentColor', style }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24"
      fill={extra.fill||"none"} stroke={color} strokeWidth="2"
      strokeLinecap="round" strokeLinejoin="round" style={style}
      dangerouslySetInnerHTML={{__html: paths}}/>
  );
  const Fish=({size=24,color='currentColor',style})=>(
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}>
      <path d="M6.5 12c.94-3.46 4.94-6 8.5-6 3.56 0 6.06 2.54 7 6-1.44 3.46-4.5 6-7 6-3.5 0-7-2.54-7-6z"/><path d="M18 12l4-3.5-4-3.5"/><circle cx="10" cy="12" r="1" fill={color} stroke="none"/>
    </svg>);
  const MapPin=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M20 10c0 6-8 12-8 12S4 16 4 10a8 8 0 0 1 16 0z"/><circle cx="12" cy="10" r="3"/></svg>);
  const Droplets=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.57-2.26-1.71-3.19S7.29 6.75 7 5.3c-.29 1.45-1.14 2.84-2.29 3.76S3 11.1 3 12.25c0 2.22 1.8 4.05 4 4.05z"/><path d="M12.56 6.6A10.97 10.97 0 0 0 14 3.02c.5 2.5 2 4.9 4 6.5s3 3.5 3 5.5a6.98 6.98 0 0 1-11.91 4.97"/></svg>);
  const Wind=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M17.7 7.7a2.5 2.5 0 1 1 1.8 4.3H2"/><path d="M9.6 4.6A2 2 0 1 1 11 8H2"/><path d="M12.6 19.4A2 2 0 1 0 14 16H2"/></svg>);
  const Thermometer=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z"/></svg>);
  const Home=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>);
  const User=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>);
  const Send=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>);
  const Mic=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="22"/></svg>);
  const ChevronRight=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><polyline points="9 18 15 12 9 6"/></svg>);
  const Waves=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M2 6c.6.5 1.2 1 2.5 1C7 7 7 5 9.5 5c2.6 0 2.4 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"/><path d="M2 12c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 2.6 0 2.4 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"/><path d="M2 18c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 2.6 0 2.4 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"/></svg>);
  const Gauge=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="m12 14 4-4"/><path d="M3.34 19a10 10 0 1 1 17.32 0"/></svg>);
  const Star=({size=24,color='currentColor',fill='none',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" fill={fill}/></svg>);
  const TrendingUp=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>);
  const AlertCircle=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>);
  const Clock=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>);
  const Anchor=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><circle cx="12" cy="5" r="3"/><line x1="12" y1="22" x2="12" y2="8"/><path d="M5 12H2a10 10 0 0 0 20 0h-3"/></svg>);
  const MessageCircle=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>);
  const Newspaper=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2"/><path d="M18 14h-8"/><path d="M15 18h-5"/><path d="M10 6h8v4h-8V6z"/></svg>);
  const LogOut=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>);
  const Plus=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>);
  const Camera=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>);
  const VideoIcon=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>);
  const PlayIcon=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill={color} stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><polygon points="5 3 19 12 5 21 5 3"/></svg>);
  const PauseIcon=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill={color} stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>);
  const ImageIcon=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>);
  const AttachIcon=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>);
  const XIcon=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>);
  const RefreshCw=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/></svg>);
  const BellIcon=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>);
  const BellOffIcon=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M13.73 21a2 2 0 0 1-3.46 0"/><path d="M18.63 13A17.89 17.89 0 0 1 18 8"/><path d="M6.26 6.26A5.86 5.86 0 0 0 6 8c0 7-3 9-3 9h14"/><path d="M18 8a6 6 0 0 0-9.33-5"/><line x1="1" y1="1" x2="23" y2="23"/></svg>);
  const Cloud=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"/></svg>);
  const BookOpen=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>);
  const Trophy=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2z"/></svg>);
  const Share2=({size=24,color='currentColor',style})=>(<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>);
  ...
  const C = {
    ...
    text:"#e8f4f0", muted:"rgba(232,244,240,0.45)", dimmer:"rgba(232,244,240,0.25)",
  };
  const glass = (extra="") => ({
  ...
  async function fetchWeather(lat = 47.27, lon = 39.87) {
  ...
  function calcBiteScore(pressure, month, wind=0, waterTemp=15, rain=0) {
    let score = 6;
    // Давление
  ...
  // Ближайшие магазины по геолокации (SHOPS определён ниже, доступен при вызове)
  const fmtNearestShops = (n = 2) => {
  ...
  const ALL_SPOTS_TEXT = `Топ точек по Ростовской области:\n\n📍 Вторая дамба (Аксай) — лещ, сазан, карп\nhttps://yandex.ru/maps/?pt=39.8699,47.2681&z=14\n\n📍 Гниловская переправа — судак, жерех\nhttps://yandex.ru/maps/?pt=39.7012,47.1734&z=14\n\n📍 Мёртвый Донец (Ливенцовка) — щука, карась\nhttps://yandex.ru/maps/?pt=39.6234,47.2198&z=14\n\n📍 Камышовая заводь (Батайск) — карась, карп\nhttps://yandex.ru/maps/?pt=39.7456,47.1456&z=14\n\n📍 Перекат ниже Аксая — сазан\nhttps://yandex.ru/maps/?pt=39.9012,47.2456&z=14\n\n📍 Цимлянское вдхр. — лещ, судак, сом\nhttps://yandex.ru/maps/?pt=42.0954,47.6421&z=14\n\n📍 Манычское вдхр. (Пролетарск) — амур, карп\nhttps://yandex.ru/maps/?pt=41.7234,46.7012&z=14`;

  const pick = arr => arr[Math.floor(Math.random()*arr.length)];

  const moonPhase = () => {
    const ref = new Date(2024, 0, 11); // эталонное новолуние
    const p = ((( new Date() - ref) / 86400000 % 29.53) + 29.53) % 29.53;
    if(p < 1.85)  return {ico:"🌑", tip:"Новолуние — хищник максимально активен ночью"};
    if(p < 7.38)  return {ico:"🌒", tip:"Растущая луна — хороший клёв хищника"};
    if(p < 9.22)  return {ico:"🌓", tip:"Первая четверть — умеренный клёв, лучше в заводях"};
    if(p < 14.76) return {ico:"🌔", tip:"Луна прибывает — лещ и сазан выходят на бровки"};
    if(p < 16.61) return {ico:"🌕", tip:"Полнолуние — мирная рыба активна весь день"};
    if(p < 22.15) return {ico:"🌖", tip:"Убывающая луна — лещ, сазан, плотва берут стабильно"};
    if(p < 23.99) return {ico:"🌗", tip:"Последняя четверть — клёв нестабилен, меняй насадку"};
    return {ico:"🌘", tip:"Луна сходит — ставь на мирную рыбу"};
  };

  const seasonFish = m => ["плотва, окунь, щука","плотва, окунь, щука","щука + плотва, жерех выходит","лещ, плотва, жерех, окунь","лещ, сазан, карась, жерех, тарань","лещ, сазан, карась, карп, амур","амур, карп, сазан — рано утром","амур, карп, судак, лещ","судак, щука, лещ — начало жора","судак, щука, берш, лещ — осенний жор","судак, щука, берш, лещ","плотва, окунь, щука"][m] || "лещ, судак";

  const nearestFishSpot = (fish) => {
  ...
  const INTENTS = [
    ...
    // ── Подготовка к рыбалке / что взять ──
    ...
    { t:["нахлыст","нахлыстом","нахлыстовая","на мушку"],
      fn:(l)=>{
        ...
        if(l.match(/снасть|удилищ|шнур|катушк|выбрать|какое|AFTM/)) return `Нахлыстовые снасти для Дона:\n\n🎣 Удилище:\n• AFTM 5–6, 9 футов — универсальный класс ✅\n• На ветру лучше AFTM 6–7 — тяжёлый шнур не сносит\n• Длина 9 футов — оптимально для перекатов\n\n🎣 Шнур:\n• WF (Weight Forward) — проще забрасывать новичку ✅\n• Floating (F) — для сухих мушек, поверхностная ловля\n• Sink Tip (S) или Intermediate — для нимф в толще воды\n\n🎣 Подлесок:\n2.7–4.5 м, конец (типпет) 0.12–0.14 мм — длиннее подлесок = тоньше презентация мушки\n\n🎣 Катушка:\nПростая дисковая — нахлыст это больше про шнур, катушка второстепенна\n\n💰 Бюджет на старт: 3000–6000 руб за комплект — и этого хватит надолго.${shopLinks("нахлыстовое удилище шнур катушка набор")}`;
        if(l.match(/мушк|приманк|на что|нимф|стример|сухая/)) return `Мушки для Дона — что работает:\n\n🌿 Сухие мушки (поверхность):\n• Elk Hair Caddis #12–14 — универсальная, голавль 100%\n• Parachute Adams #12–14 — любая погода\n• Кузнечик (Hopper) #8–10 — август-сентябрь, голавль жадно берёт!\n\n🌊 Нимфы (под водой):\n• Hare's Ear Nymph #12 — самая уловистая\n• Pheasant Tail #12–14 — имитация ручейника\n• Bead Head Prince #10–12 — придонная ловля\n\n🐟 Стримеры (хищник):\n• Wooly Bugger #6–8 чёрный/оливковый — жерех и голавль\n• Clouser Minnow — имитация малька под щуку и жереха\n\nПравило: летом — сухие мушки. Осенью и в пасмурную погоду — нимфы у дна.${shopLinks("нахлыстовые мушки набор нимфы стример набор")}`;
        if(l.match(/техник|заброс|как бросать|как кидать|заброс/)) return `Техника нахлыстового заброса:\n\n🎯 Базовый заброс (петлевой):\n1. Вытяни 5–7 м шнура перед собой\n2. Бросок назад — удилище до положения 1 час, СТОП\n3. Ключевое: ЖДИ 1–2 сек — шнур должен полностью распрямиться сзади\n4. Бросок вперёд — удилище до 10 часов, СТОП — пусть шнур ложится сам\n\n❌ Главные ошибки:\n• Торопиться — шнур сзади не распрямился, петля сложилась\n• Слишком сильный бросок — шнур уходит в "пропеллер"\n• Держишь запястье — веди только предплечьем, запястье жёсткое!\n\n✅ Упражнение: встань на газоне, сними мушку. Забрасывай шнур — смотри как он ложится. 30 мин в день — и через неделю получится!\n\nПосмотри видео "нахлыстовый заброс для начинающих" — на практике понятнее.${shopLinks("нахлыстовое удилище шнур набор для начинающих")}`;
        return pick([
    ...
    { t:["какое удилище","какую удочку","выбрать удилище","выбрать удочку","посоветуй удилище","посоветуй удочку","удилище купить","удочку купить","какой спиннинг купить","выбор удилища","помоги выбрать удилище","подобрать удилище"],
      fn:(l)=>{
        ...
        if(l.match(/фидер/)) return getBotReply("выбрать фидерное удилище", null);
        if(l.match(/нахлыст/)) return getBotReply("нахлыст удилище снасть", null);
    ...
    // ── Снаряжение / рыболовный ящик / чемодан ──
  ...
  const getBotReply = (q, weather) => {
    ...
    // Умный фоллбек — пробуем угадать по ключевым словам
    ...
    if(l.match(/как|совет|помоги|объясн|расскаж|научи/)){
      return pick([
        ...
        `Конечно помогу! Уточни: про какую рыбу? Или какую снасть хочешь освоить — фидер, спиннинг, поплавок, нахлыст?`,
      ]);
    }
    // Если совсем ничего не нашли — ответ на основе погоды
    if(weather){
      const month = new Date().getMonth();
    ...
    return pick([
      ...
      `Хм, не совсем понял — но готов помочь! 😄\n\nСпрашивай про рыбу (куда, на что, когда), про снасти (что выбрать, как собрать), или про конкретную технику — фидер, нахлыст, спиннинг, поплавок. Отвечу как знаю.`,
    ]);
  };

  // ── Context-aware AI wrapper ──
  const FISH_NAMES = ["амур","щука","лещ","карась","сазан","судак","карп","плотва","тарань","голавль","красноперка","толстолобик","чехонь","сом","окунь","жерех","берш","бычок","линь","пиленгас"];
  const detectFish = l => FISH_NAMES.find(f=>l.includes(f));

  const getBotReplyCtx = (q, weather, ctx={}) => {
    const l = q.toLowerCase();
    const newCtx = {...ctx};
    const fish = detectFish(l);
    if(fish) newCtx.fish = fish;

    // ── Отслеживаем тему разговора ──
    ...
    // ── "Расскажи ещё" / "Подробнее" / "Что ещё" ──
    ...
    // ── resolve pending: waiting for fish name ──
    if(ctx.pending === 'fish') {
      if(fish) {
        newCtx.pending = null;
    ...
    // ── resolve pending: waiting for topic selection ──
    if(ctx.pending === 'topic' && ctx.fish) {
      ...
      // topic not matched — fall through to normal processing
    }

    // ── context-enhanced "где/куда" without fish ──
    ...
    // ── context-enhanced "на что/насадки" without fish ──
    ...
    // ── context-enhanced "снасти" without fish ──
  ...
  // Yandex Maps helpers (Yandex uses lon,lat order, opposite of Google)
  const ymaps   = (latlon) => { const [la,lo]=String(latlon).split(",").map(s=>s.trim()); return `https://yandex.ru/maps/?pt=${lo},${la}&z=14`; };
  const ymapsLL = (lat,lon) => `https://yandex.ru/maps/?pt=${lon},${lat}&z=14`;
  ...
  const fmtTime = () => new Date().toLocaleTimeString("ru-RU",{hour:"2-digit",minute:"2-digit"});
  const fmtDate = (ts) => {
    if (!ts) return "";
    const d = ts.toDate ? ts.toDate() : new Date(ts);
    return d.toLocaleDateString("ru-RU",{day:"numeric",month:"short"})+" "+d.toLocaleTimeString("ru-RU",{hour:"2-digit",minute:"2-digit"});
  };
  const PRESSURE_DATA = [757,758,756,759,761,760,762,761,763,762,764,763];
  ...
  /* ── Sparkline ── */
  function Sparkline({ data, width=280, height=60, nowIdx }) {
  ...
  /* ── WPill ── */
  function WPill({ Icon, val, label, color=C.accent, loading }) {
    return (
  ...
  function WaveIcon({size=20}){return(<svg width={size} height={size} viewBox="0 0 24 24" fill="none"><path d="M2 14 Q6 10 10 14 Q14 18 18 14 Q20 12 22 14" stroke={C.cyan} strokeWidth="2" strokeLinecap="round"/><path d="M2 18 Q6 14 10 18 Q14 22 18 18 Q20 16 22 18" stroke={C.cyan} strokeWidth="1.5" strokeLinecap="round" opacity="0.5"/></svg>);}
  ...
  function AuthModal({ onClose, onSuccess }) {
    ...
    const submit = async () => {
      ...
      try {
        if (mode==="register"){const c=await auth.createUserWithEmailAndPassword(email,password);await c.user.updateProfile({displayName:name});}
        else{await auth.signInWithEmailAndPassword(email,password);}
        onSuccess?.();
      } catch(e){setError(errMap[e.code]||e.message);}
      setLoading(false);
    };
    const inp=(val,set,ph,type="text")=>(<input type={type} value={val} onChange={e=>set(e.target.value)} placeholder={ph} onKeyDown={e=>e.key==="Enter"&&submit()} style={{width:"100%",padding:"13px 16px",borderRadius:12,background:"rgba(255,255,255,0.07)",border:`1px solid ${C.border}`,color:C.text,fontSize:15,outline:"none",marginBottom:10}} onFocus={e=>e.target.style.borderColor=C.accent} onBlur={e=>e.target.style.borderColor=C.border}/>);
    return (
  ...
  function RequireAuth({ user, onLogin, children }) {
  ...
  function Typing(){return(<div style={{display:"flex",alignItems:"center",gap:8,marginBottom:12}}><div style={{width:34,height:34,borderRadius:"50%",background:`linear-gradient(135deg,${C.accent},${C.cyan})`,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:`0 0 14px ${C.accentGlow}`,flexShrink:0}}><Fish size={17} color="#07111e"/></div><div style={{padding:"12px 16px",borderRadius:"18px 18px 18px 4px",background:"rgba(255,255,255,0.07)",border:`1px solid ${C.border}`,display:"flex",gap:5,alignItems:"center"}}>{[0,1,2].map(i=>(<div key={i} style={{width:7,height:7,borderRadius:"50%",background:C.accent,animation:`bounce 1.2s ease ${i*.2}s infinite`}}/>))}</div></div>);}

  /* ── HOME ── */
  function HomeScreen({ onGoChat, weather, weatherLoading, onRefreshWeather, setTab, userLat, userLon, user, onLogin }) {
    const month = new Date().getMonth();
    ...
    // Ближайшие водоёмы по геолокации
    ...
    // Уровень воды из Firestore (бот обновляет каждый час)
    const [waterLevel,setWaterLevel]=useState(null);
    useEffect(()=>{
      const unsub=db.collection("water_levels").doc("don-rostov").onSnapshot(doc=>{
        if(doc.exists) setWaterLevel(doc.data());
      });
      return unsub;
    },[]);

    // Сезонный запасной уровень если Firestore пустой
    ...
    const pressureData = useMemo(()=>{
      ...
      // 12 bars: nowHour-5 … nowHour (index 5) … nowHour+6
    ...
    const pressureLabels = useMemo(()=>{
      // 6 labels; label[2] = "сейчас" aligns visually with bar 5 (nowHour)
    ...
    useEffect(()=>{
      db.collection("reports").orderBy("timestamp","desc").limit(5).get()
        .then(snap=>setRecentCatches(snap.docs.map(d=>({...d.data(),id:d.id}))))
        .catch(()=>{});
    },[]);

    // User quick stats + profile for AI advice
    const [quickStats, setQuickStats] = useState(null);
    const [userProfile, setUserProfile] = useState(null);
    useEffect(()=>{
      if(!user?.uid) return;
      db.collection("catches").doc(user.uid).collection("records")
    ...
    // Nearby catches (within 20km, last 6 hours)
    const [nearbyCatches, setNearbyCatches] = useState([]);
    useEffect(()=>{
      if(!userLat||!userLon) return;
      const since = new Date(Date.now() - 6*60*60*1000);
      db.collection("reports").where("timestamp",">=",firebase.firestore.Timestamp.fromDate(since))
    ...
    // AI advice — computed after all state is declared
    const egerAdvice = useMemo(()=>{
      if (!weather) return "Загружаю актуальный прогноз...";
      const moon = moonPhase();
      const p=weather.pressure, wt=weather.waterTemp, wind=weather.wind;
      let pDir=0;
      ...
      const isNight=nowHour>=22||nowHour<4, isDawn=nowHour>=4&&nowHour<8;
      const isMorn=nowHour>=8&&nowHour<13, isEve=nowHour>=18&&nowHour<22;
      const timeIco=isNight?"🌙":isDawn?"🌅":isMorn?"☀️":isEve?"🌆":"🌤";
      const timeName=isNight?"ночью":isDawn?"на рассвете":isMorn?"утром":isEve?"вечером":"днём";
      let fish,gear;
      if(isNight&&wt>16){fish="сом";gear="донка с живцом";}
      else if((isDawn||isEve)&&pDir<=-2){fish="судак";gear="джиг";}
      else if(isDawn||isEve){fish="щука";gear="воблер / спиннинг";}
      else if(pDir>2){fish="лещ и сазан";gear="фидер";}
      else if(pDir<-2){fish="судак и берш";gear="джиг";}
      else if(wt>=20&&(isMorn||isEve)){fish="карп";gear="бойлы / кукуруза";}
      else if(month>=10||month<=1){fish="окунь";gear="мормышка / балансир";}
      else{fish="лещ";gear="фидер / донка";}
      const defSpot=nearestSpots[0]?.name||currentBody.name;
      const spot=(userProfile?.topLoc?.name)||defSpot;
      const mainLine=`${timeIco} ${timeName.charAt(0).toUpperCase()+timeName.slice(1)} — ${fish} на ${gear} у ${spot}.`;
      const pLine=pDir>2?`Давление растёт (${p} мм) — мирная рыба активна.`
                :pDir<-2?`Давление падает (${p} мм) — хищник активизируется.`
                :`Давление стабильно ${p} мм, вода ${wt>0?"+":""}${wt}°C.`;
      let personalLine="";
      if(userProfile&&userProfile.total>=3){
        const nearBest=Math.abs(nowHour-userProfile.bestHour)<=1&&userProfile.bestHour>0;
        if(nearBest){
          personalLine=`По вашей статистике это ваш лучший час для поклёвок!`;
        } else if(userProfile.topFish){
          const bh=userProfile.bestHour;
          const hoursLeft=((bh-nowHour)+24)%24;
          if(hoursLeft<=8&&hoursLeft>1) personalLine=`Ваш лучший час через ${hoursLeft}ч (${bh}:00).`;
          else personalLine=`Вы чаще ловите ${userProfile.topFish.name}${userProfile.topGear?` на ${userProfile.topGear.name}`:""}${userProfile.topLoc?` у ${userProfile.topLoc.name}`:""}.`;
        }
      }
      let extraTip="";
      if(wt>=24) extraTip=`Вода ${wt}°C — ищите глубину от 3м.`;
      else if(wt<=8) extraTip=`Вода холодная ${wt}°C — медленная проводка.`;
      else if(wind>7) extraTip=`Ветер ${wind} м/с — держитесь у укрытых берегов.`;
      else if(month>=3&&month<=4) extraTip="Нерест — щука и окунь на мелководье.";
      else if(month>=9&&month<=10) extraTip="Осенний жор — лучший сезон для трофея!";
      let nearbyLine="";
      if(nearbyCatches.length>0){
        const nc=nearbyCatches[0];
        const ms=nc.timestamp?.toMillis?.()??Date.now();
        const mins=Math.round((Date.now()-ms)/60000);
        const t=mins<60?`${mins} мин`:`${Math.floor(mins/60)}ч`;
        const dist=userLat?Math.round(haversine(userLat,userLon,nc.lat,nc.lng||nc.lon)):null;
        nearbyLine=`⚡ ${nc.displayName||"Рыбак"} поймал ${nc.fish||"рыбу"} ${nc.weight?nc.weight+" кг ":""}${dist?`в ${dist} км `:""} — ${t} назад!`;
      }
      return [moon.ico,mainLine,pLine,personalLine,extraTip,nearbyLine].filter(Boolean).join(" ");
    },[weather,userProfile,nowHour,month,nearestSpots,currentBody,nearbyCatches,userLat,userLon]);
      ...
      <div style={{padding:"0 14px",overflowY:"auto",height:"100%",paddingBottom:20}}>
        <div style={{...glass(`0 8px 32px rgba(0,0,0,.4),0 0 0 1px ${C.borderHi}`),background:"linear-gradient(135deg,rgba(46,204,113,.12) 0%,rgba(34,211,238,.08) 50%,rgba(59,130,246,.10) 100%)",padding:20,marginBottom:14,position:"relative",overflow:"hidden",animation:"fadeUp .5s ease"}}>
          ...
          <div style={{background:"rgba(0,0,0,.3)",borderRadius:14,padding:"12px 14px",borderLeft:`3px solid ${C.accent}`}}>
            <div style={{fontSize:10,color:C.accent,letterSpacing:2,fontWeight:700,marginBottom:5}}>ИИ-СОВЕТ ЕГЕРЯ</div>
            <div style={{fontSize:13,color:"rgba(232,244,240,.85)",lineHeight:1.7}}>
              {egerAdvice}
            </div>
          </div>
        </div>
        ...
        {(()=>{
          // Объединяем точки и базы, сортируем по расстоянию
          const allPts = [
  ...
  function ChatScreen({ weather, userLat, userLon, user, onLogin }) {
    ...
    // Загружаем базу знаний (накопленные ответы Claude)
    useEffect(()=>{
      if(!user) return;
      const unsub = db.collection("bot_kb").orderBy("timestamp","desc").limit(300)
        .onSnapshot(snap=>{ kbRef.current = snap.docs.map(d=>d.data()); }, ()=>{});
      return unsub;
    },[user]);

    // Ищем похожий вопрос в базе знаний по ключевым словам
    ...
    // Fallback local bot reply (used if Cloud Function fails)
    ...
    // Real AI via Claude (Cloud Function) with local fallback
    const callAI = async (userText) => {
      ...
      setTyping(true);
      try {
        const fn = functionsRegion.httpsCallable("askEger");
    ...
    const sendPhoto = async (file) => {
      ...
      try {
        const ref = storage.ref(`chat_photos/egер_${Date.now()}.jpg`);
  ...
  /* ── WEATHER ── */
  function WeatherScreen({ weather, weatherLoading, onRefresh }) {
    ...
    return (
      <div style={{height:"100%",overflowY:"auto",padding:"12px 14px 32px"}}>
        ...
        {(()=>{
          ...
          // Moon transit at Rostov-on-Don (UTC+3): each synodic day (24h50m) shifts transit ~50min
        ...
        {weather.daily && (()=>{
          ...
          const best=scores.reduce((b,s,i)=>s>scores[b]?i:b,1); // skip today (0), start from tomorrow
        ...
        {(()=>{
          ...
          const speciesForecast=[
            {name:"Судак",   score:Math.min(10,Math.round((p>=752&&p<=768?3:1)+(t>=8&&t<=22?3:1)+(w<=5?2:1)+(mp>0.3&&mp<0.7?2:1)))},
            {name:"Щука",    score:Math.min(10,Math.round((p>=748&&p<=762?3:1)+(t>=6&&t<=20?3:1)+(w<=6?2:1)+(mp<0.35||mp>0.65?2:1)))},
            {name:"Лещ",     score:Math.min(10,Math.round((p>=758&&p<=770?4:1)+(t>=12&&t<=26?3:1)+(w<=4?2:1)+(mp>0.45&&mp<0.55?2:1)))},
            {name:"Карп",    score:Math.min(10,Math.round((p>=755&&p<=768?3:p>768?4:1)+(t>=15&&t<=28?4:1)+(w<=3?2:1)+(mp>0.4&&mp<0.6?2:1)))},
            {name:"Сом",     score:Math.min(10,Math.round((p>=748&&p<=762?3:1)+(t>=18&&t<=30?4:1)+(w<=4?2:1)+(mp>0.6?2:1)))},
            {name:"Окунь",   score:Math.min(10,Math.round((p>=750&&p<=770?3:1)+(t>=10&&t<=24?3:1)+(w<=5?2:1)+(mp>0.35&&mp<0.65?2:1)))},
  ...
  function SuggestSpotForm({ user, userLat, userLon, onClose }) {
    ...
    const handleSave = async () => {
      ...
      setSaving(true);
      try {
        await db.collection("suggested_spots").add({
  ...
  function MapScreen({ userLat, userLon, user }) {
    ...
    const allFish = useMemo(()=>{
      const set = new Set();
      SPOT_LIST.forEach(s=>s.fish.split(/[,，]+/).forEach(f=>{ const t=f.trim(); if(t) set.add(t); }));
      return [...set].sort();
    },[]);
    ...
    const centerLon = sel ? sel.lon : 39.95;
    const centerLat = sel ? sel.lat : 47.24;
    const zoom = sel ? 13 : 8;
    ...
    return (
      <div style={{height:"100%",display:"flex",flexDirection:"column",overflow:"hidden"}}>
        ...
        <div style={{flex:"0 0 44%",position:"relative",background:"#0a192f"}}>
          {!mapLoaded&&<div style={{position:"absolute",inset:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:10,background:"rgba(7,17,30,.95)",zIndex:1}}>
            ...
            <a href={`https://yandex.ru/maps/?ll=${centerLon},${centerLat}&z=${zoom}`} target="_blank" rel="noreferrer" style={{fontSize:11,color:C.accent,textDecoration:"none"}}>Открыть в Яндекс.Картах ↗</a>
          </div>}
          <iframe
            key="yandex-spots-map"
            src={mapSrc}
            style={{width:"100%",height:"100%",display:"block",border:"none",opacity:mapLoaded?1:0,transition:"opacity .5s"}}
            frameBorder="0"
  ...
  function DMScreen({ user, otherUser, onClose }) {
    ...
    useEffect(()=>{
      ...
      const unsub=db.collection("dms").doc(dmId).collection("messages")
    ...
    const send = async () => {
      ...
      db.collection("dms").doc(dmId).set({
        lastMessage:text, lastAt:firebase.firestore.FieldValue.serverTimestamp(),
        [`unread_${otherUser.uid}`]:firebase.firestore.FieldValue.increment(1)
      },{merge:true});
    };
  ...
  function CommunityScreen({ user, onLogin }) {
    ...
    const [vidUpPct, setVidUpPct] = useState(null);
    // voice state
    const [voiceRec, setVoiceRec] = useState(false);
    ...
    useEffect(()=>{
      const unsub=db.collection("messages").orderBy("timestamp","desc").limit(50).onSnapshot(snap=>{
    ...
    const loadOlderMsgs = async () => {
      ...
      try {
        const snap=await db.collection("messages").orderBy("timestamp","desc").startAfter(oldestDocRef.current).limit(50).get();
    ...
    useEffect(()=>{
      ...
      ref.get().then(doc=>{
        if(doc.exists && doc.data().username){ setUsername(doc.data().username); return; }
        const uname=genUsername(user.displayName);
        ref.set({username:uname,displayName:user.displayName||"Рыбак"},{merge:true});
        setUsername(uname);
      });
      db.collection("users").doc(user.uid).collection("badges").get().then(snap=>{
    ...
    // строит base в момент вызова (не при рендере) — избегает stale uid
    const mkBase = () => ({
      uid: user.uid,
    ...
    const toggleReaction = async (msgId, emoji) => {
      ...
      try {
        ...
        const upd={};
        // Снять предыдущую реакцию пользователя (одна реакция на пользователя)
        for(const [e, uids] of Object.entries(reactions)){
          if(Array.isArray(uids)&&uids.includes(user.uid)){
            ...
            upd[`reactions.${e}`]=filtered.length>0?filtered:firebase.firestore.FieldValue.delete();
          }
        }
        // Добавить новую, если не совпадает с предыдущей (нажал ту же — снял)
    ...
    const send = async () => {
      ...
      if(editingMsg) {
        ...
        try {
          await db.collection("messages").doc(editingMsg.id).update({text, edited: true});
      ...
      try {
        ...
        setInput(text);
        alert("Ошибка отправки: " + e.message + "\n\nПроверь правила Firestore — разреши write для коллекции messages.");
      }
    };
    ...
    const sendPhoto = async (file) => {
      ...
      try {
        ...
        await db.collection("messages").add({...mkBase(), type:"image", imageUrl:url});
      } catch(e) {
    ...
    const sendVideoFile = async (file) => {
      ...
      try {
        ...
        await db.collection("messages").add({...mkBase(), type:"video", videoUrl:url});
      } catch(e) {
    ...
    const flipCamera = async () => {
      if(vidRec) return; // нельзя флипнуть во время записи
      ...
      try {
        ...
        mr.onstop = async () => {
          ...
          try {
            ...
            await db.collection("messages").add({...mkBase(), type:"voice", voiceUrl:url, dur});
        ...
        <div style={{padding:"10px 16px 8px",borderBottom:`1px solid ${C.border}`}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
            ...
            <div style={{display:"flex",gap:6,alignItems:"center"}}>
              <button onClick={()=>{setSearchOpen(o=>!o);setSearchQuery("");}} style={{width:34,height:34,borderRadius:"50%",border:`1px solid ${searchOpen?C.borderHi:C.border}`,background:searchOpen?C.accentDim:C.surface,color:searchOpen?C.accent:C.muted,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:15,transition:"all .2s"}}>🔍</button>
          ...
          {searchOpen&&(
            <div style={{marginTop:8,display:"flex",gap:8,alignItems:"center",animation:"fadeIn .2s ease"}}>
              ...
              {searchQuery.trim()&&<span style={{fontSize:11,color:C.muted,flexShrink:0,whiteSpace:"nowrap"}}>{displayMsgs.length} сообщ.</span>}
            </div>
          )}
        </div>
          ...
          {displayMsgs.map((msg,i)=>{
            ...
            return (
              <div key={msg.id} style={{display:"flex",flexDirection:"column",alignItems:isMe?"flex-end":"flex-start",marginBottom:sameAsPrev?3:10,animation:"fadeUp .25s ease"}}>
                ...
                {/* Action bar: reply + reactions + edit/delete */}
  ...
  function NewsScreen({ user, onLogin, userLat, userLon }) {
    ...
    const triggerRefresh=async()=>{
      ...
      setRefreshing(true);
      try{
        const fn=functionsRegion.httpsCallable("triggerFetchNews");
        await fn({});
    ...
    // Реальное время: Firestore onSnapshot (бот пишет, сайт читает)
    useEffect(()=>{
      const unsub=db.collection("news").orderBy("timestamp","desc").limit(20)
        .onSnapshot(snap=>{
    ...
    useEffect(()=>{
      const unsub=db.collection("reports").orderBy("timestamp","desc").limit(50)
        .onSnapshot(s=>{setReports(s.docs.map(d=>({id:d.id,...d.data()}))); setReportsErr(false);},
    ...
    const uploadPhoto=async uid=>{
      ...
      const ref=storage.ref(`reports/${uid}_${Date.now()}.jpg`);
    ...
    const submitReport=async()=>{
      ...
      try {
        ...
        const data={...form,uid:user.uid,displayName:user.displayName||"Рыбак",timestamp:firebase.firestore.FieldValue.serverTimestamp(),...(photo_url?{photo_url}:{}),...(userLat&&userLon?{lat:userLat,lng:userLon}:{})};
        if(editTarget) await db.collection("reports").doc(editTarget.id).update(data);
        else await db.collection("reports").add(data);
        setShowForm(false); setForm({title:"",body:"",location:"",fish:""}); setPhotoFile(null); setPhotoPreview(null); setEditTarget(null);
      } catch(e){ alert("Ошибка: "+e.message); }
      setPosting(false);
    };

    const deleteReport=async id=>{ if(!window.confirm("Удалить отчёт?")) return; await db.collection("reports").doc(id).delete(); };

    const toggleReportLike=async(reportId,currentLikes)=>{
      if(!user){onLogin();return;}
      const ref=db.collection("reports").doc(reportId);
      const hasLiked=(currentLikes||[]).includes(user.uid);
      await ref.update({likes:hasLiked?firebase.firestore.FieldValue.arrayRemove(user.uid):firebase.firestore.FieldValue.arrayUnion(user.uid)}).catch(()=>{});
    };
          ...
          {tab==="reports"&&<div>
            ...
            {reports.map(r=>{
              ...
              return (<div key={r.id} style={{...glass(),padding:"14px",marginBottom:10,animation:"fadeUp .3s ease"}}>
                ...
                {r.photo_url&&<img src={r.photo_url} alt="улов" onClick={()=>window.open(r.photo_url,"_blank")} style={{width:"100%",maxHeight:200,objectFit:"cover",borderRadius:10,marginBottom:10,cursor:"pointer",display:"block"}}/>}
  ...
  /* ── PROFILE ── */
  function ProfileScreen({ user, onLogin, onNav }) {
    ...
    const saveUsername = async () => {
      ...
      if (!u) return;
      await db.collection("users").doc(user.uid).set({username:u},{merge:true});
    ...
    const toggleNotif = async () => {
      ...
      try {
        ...
        const token = await messaging.getToken({vapidKey:VAPID_KEY, serviceWorkerRegistration:reg});
        if (token) {
          await db.collection("fcm_tokens").doc(token).set({createdAt:firebase.firestore.FieldValue.serverTimestamp(), ua:navigator.userAgent.slice(0,100)});
    ...
    useEffect(()=>{
      db.collection("users").doc(user.uid).get().then(doc=>{
        if(doc.exists && doc.data().username) setProfileUsername(doc.data().username);
        else setProfileUsername(genUsername(user.displayName||"рыбак"));
      });
      // Try to get user's rank from leaderboard
      db.collection("leaderboard").doc("month").collection("rows").doc(user.uid).get()
    ...
    useEffect(()=>{
      ...
      db.collection("catches").doc(user.uid).collection("records")
        ...
        .then(snap=>{
          ...
          // Time-of-day distribution (group into 4h buckets: night/morning/day/evening)
      ...
      db.collection("users").doc(user.uid).collection("badges").get()
    ...
    return (
      <div style={{padding:"16px 14px",overflowY:"auto",height:"100%"}}>
        ...
        <button onClick={()=>auth.signOut()} style={{width:"100%",marginTop:8,padding:"14px 16px",borderRadius:20,border:"1px solid rgba(239,68,68,.3)",background:"rgba(239,68,68,.1)",display:"flex",alignItems:"center",justifyContent:"center",gap:8,cursor:"pointer"}}>
  ...
  /* ── Список точек для HomeScreen (сортируется по геолокации) ── */
  const SPOT_LIST = [
    // ── Аксай / Нижний Дон ──
  ...
  /* ── Населённые пункты для геокодирования ── */
  const GEO_CITIES = [
  ...
  /* ── Рыболовные базы и платная рыбалка ── */
  const FISHING_BASES = [
  ...
  /* ═══════════════════════════════════════════════════════
     CATCH SYSTEM — константы, флоу и дневник
  ═══════════════════════════════════════════════════════ */
  const FISH_TYPES = [
  ...
  const GEAR_TYPES = ["Спиннинг","Поплавочная","Фидер","Нахлыст","Карповое","Другое"];
  const CATCH_METHODS = ["С берега","С лодки","С мостков","Вейдинг"];
  const BADGE_DEFS = [
  ...
  function getNearestSpotName(lat, lon) {
  ...
  async function checkAndAwardBadges(userId, allRecords) {
    ...
    try {
      ...
      const existing = await db.collection("users").doc(userId).collection("badges").get();
      const existingIds = new Set(existing.docs.map(d=>d.id));
      for (const {id,met} of checks) {
        if (met && !existingIds.has(id)) {
          await db.collection("users").doc(userId).collection("badges").doc(id).set({badgeId:id,unlockedAt:firebase.firestore.FieldValue.serverTimestamp()});
  ...
  async function generateShareCard(record) {
    ...
    const loc = record.locationName||"Место не указано";
    const dateStr = (()=>{
    ...
    glow.addColorStop(0,"rgba(46,204,113,0.18)"); glow.addColorStop(1,"transparent");
    ctx.fillStyle=glow; ctx.fillRect(0,0,1080,1080);
    if (record.photoUrls?.[0]) {
      try {
        const img = await new Promise((res,rej)=>{
          const i=new Image(); i.crossOrigin="anonymous";
          i.onload=()=>res(i); i.onerror=rej; i.src=record.photoUrls[0];
        });
        const scale = Math.max(1080/img.width, 1080/img.height);
        const dw=img.width*scale, dh=img.height*scale;
        ctx.drawImage(img,(1080-dw)/2,(1080-dh)/2,dw,dh);
        const ov=ctx.createLinearGradient(0,0,0,1080);
        ov.addColorStop(0,"rgba(7,17,30,0.3)"); ov.addColorStop(0.5,"rgba(7,17,30,0.05)");
        ov.addColorStop(1,"rgba(7,17,30,0.94)");
        ctx.fillStyle=ov; ctx.fillRect(0,0,1080,1080);
      } catch(e){}
    }
    // logo chip
    ctx.fillStyle="rgba(7,17,30,0.8)";
    ctx.beginPath(); ctx.roundRect(40,40,280,56,12); ctx.fill();
    ctx.fillStyle="#2ecc71"; ctx.font="bold 28px sans-serif";
    ctx.fillText("ЕГЕРЬ ИИ", 64, 78);
    ctx.fillStyle="rgba(255,255,255,0.45)"; ctx.font="22px sans-serif";
    ctx.fillText("eger-ai.app", 64, 104);
    // bottom card
    ctx.fillStyle="rgba(7,17,30,0.86)";
    ctx.beginPath(); ctx.roundRect(40,800,1000,240,20); ctx.fill();
    ctx.strokeStyle="rgba(46,204,113,0.35)"; ctx.lineWidth=1.5; ctx.stroke();
    // fish + weight
    ctx.fillStyle="#ffffff"; ctx.font="bold 68px sans-serif";
    ctx.fillText(fishName,70,890);
    if(weightStr){
      ctx.fillStyle="#2ecc71"; ctx.font="bold 76px sans-serif";
      const nm=ctx.measureText(fishName);
      ctx.fillText(weightStr,76+nm.width,890);
    }
    ctx.fillStyle="rgba(255,255,255,0.55)"; ctx.font="30px sans-serif";
    ctx.fillText("📍 "+loc.slice(0,46)+(loc.length>46?"…":""),70,945);
    ctx.fillStyle="rgba(34,211,238,0.85)"; ctx.font="26px sans-serif";
    ctx.fillText(dateStr,70,990);
    return canvas.toDataURL("image/jpeg",0.92);
  }

  async function doShareCard(record) {
    let dataUrl;
    try { dataUrl = await generateShareCard(record); } catch(e){ console.error("share card err",e); return; }
    const fish = FISH_TYPES.find(f=>f.id===record.fishType);
    const title = `${fish?.name||"Рыба"} ${record.weightGrams?(record.weightGrams/1000).toFixed(1)+" кг":""} — Егерь ИИ`;
    if (navigator.canShare) {
      try {
        const blob = await (await fetch(dataUrl)).blob();
        const file = new File([blob],"catch.jpg",{type:"image/jpeg"});
        if (navigator.canShare({files:[file]})) {
          await navigator.share({files:[file],title,text:"Мой улов: "+title});
          logEvent("catch_shared",{method:"web_share"}); return;
        }
  ...
  /* ── CatchModal ── */
  function CatchModal({ user, userLat, userLon, onClose, weather }) {
    ...
    const handleSave = async () => {
      ...
      try {
        ...
        if (photoBlob) {
          const ref = storage.ref(`catches/${user.uid}/${Date.now()}.jpg`);
        ...
        await db.collection("catches").doc(user.uid).collection("records").doc(recId).set(record);
    ...
    const handleFinish = async () => {
      if (savedRec&&(gearType||catchMethod||bait||notes)) {
        try {
          await db.collection("catches").doc(user.uid).collection("records").doc(savedRec.id).update({gearType:gearType||null,catchMethod:catchMethod||null,bait:bait||null,notes:notes||null});
          logEvent("catch_details_completed",{gear_type:gearType||"",has_bait:!!bait});
        } catch(e){}
      }
      db.collection("catches").doc(user.uid).collection("records").get().then(snap=>{
          ...
          <div style={{flex:1,overflowY:"auto",padding:20}}>
            ...
            {step===4&&(
              <div style={{display:"flex",flexDirection:"column",gap:16,alignItems:"center",paddingTop:8}}>
                ...
                <button onClick={()=>{
                  if(savedRec){
                    db.collection("catches").doc(user.uid).collection("records").doc(savedRec.id).update({isPublic:true}).catch(()=>{});
                    db.collection("reports").doc(savedRec.id).set({
    ...
    return (
      <div style={{position:"relative",overflow:"hidden",marginBottom:8,borderRadius:16}}>
        {onDelete&&<div onClick={e=>{e.stopPropagation();if(window.confirm("Удалить улов?"))onDelete(record.id);}}
          style={{position:"absolute",right:0,top:0,bottom:0,width:88,background:"#ef4444",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",cursor:"pointer",borderRadius:"0 16px 16px 0"}}>
        ...
        <div onClick={handleClick} onTouchStart={onTS} onTouchMove={onTM} onTouchEnd={onTE}
          style={{...glass(),padding:"12px 14px",display:"flex",gap:12,alignItems:"center",cursor:"pointer",borderRadius:16,
            transform:`translateX(${swipeX}px)`,transition:tRef.current.moving?"none":"transform .2s ease",position:"relative",zIndex:1}}>
          {record.photoUrls?.[0]?(
            <img src={record.photoUrls[0]} alt="" style={{width:58,height:58,objectFit:"cover",borderRadius:12,flexShrink:0}}/>
          ):(
            <div style={{width:58,height:58,borderRadius:12,background:C.accentDim,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,fontSize:26}}>🐟</div>
          )}
          <div style={{flex:1,minWidth:0}}>
            ...
            <div style={{display:"flex",gap:6,marginTop:2,flexWrap:"wrap"}}>
              ...
              {record.distanceM&&<span style={{fontSize:10,color:"rgba(34,211,238,.6)"}}>↔{record.distanceM}м</span>}
            </div>
          </div>
  ...
  function EditCatchForm({ user, record, onClose, onSaved }) {
    ...
    const handleSave = async () => {
      ...
      const updates = {
        ...
        createdAt: firebase.firestore.Timestamp.fromDate(new Date(dateStr)),
      };
      try {
        await db.collection("catches").doc(user.uid).collection("records").doc(record.id).update(updates);
    ...
    return (
      <div style={{position:"fixed",inset:0,zIndex:300,background:"rgba(0,0,0,.78)",display:"flex",alignItems:"flex-end"}}>
        <div style={{width:"100%",maxWidth:430,margin:"0 auto",background:"#0d1f35",borderRadius:"24px 24px 0 0",maxHeight:"90vh",overflowY:"auto",padding:"20px 16px 40px"}}>
          ...
          <div style={{marginBottom:20}}><div style={{fontSize:11,color:C.muted,marginBottom:6,fontWeight:700}}>ЗАМЕТКИ</div><textarea value={notes} onChange={e=>setNotes(e.target.value)} rows={2} style={{width:"100%",padding:"9px 12px",borderRadius:10,border:`1px solid ${C.border}`,background:C.surfaceHi,color:C.text,fontSize:13,boxSizing:"border-box",resize:"none",outline:"none"}}/></div>
          <button onClick={handleSave} disabled={saving||!fishType} style={{width:"100%",padding:"15px",borderRadius:16,border:"none",background:fishType?`linear-gradient(135deg,#1a8a50,${C.accent})`:"#1e3a2a",color:fishType?"#07111e":"#4a6e5a",fontSize:15,fontWeight:800,cursor:fishType?"pointer":"default"}}>{saving?"Сохраняем...":"✅ Сохранить изменения"}</button>
        </div>
      </div>
    );
  }
  ...
  function CatchDetailView({ record: initRecord, user, onBack }) {
    ...
    const handleDelete = async () => {
      ...
      setDeleting(true);
      try {
        await db.collection("catches").doc(user.uid).collection("records").doc(record.id).delete();
        // Также удаляем из публичной ленты если был опубликован
        if (record.isPublic) db.collection("reports").doc(record.id).delete().catch(()=>{});
        onBack();
      }
    ...
    const handlePublish = async () => {
      try {
        await db.collection("catches").doc(user.uid).collection("records").doc(record.id).update({isPublic:true});
        await db.collection("reports").doc(record.id).set({
        ...
        <div style={{padding:"0 0 24px",flex:1}}>
          ...
          <div style={{padding:"16px 14px"}}>
            ...
            <div style={{display:"flex",gap:8,marginBottom:8}}>
              <button onClick={()=>doShareCard(record)} style={{flex:1,padding:"12px",background:"rgba(34,211,238,.1)",border:"1px solid rgba(34,211,238,.3)",borderRadius:14,color:C.cyan,fontSize:13,fontWeight:700,cursor:"pointer"}}>
                📤 Поделиться
              </button>
  ...
  function ManualCatchForm({ user, userLat, userLon, onClose, onSaved }) {
    ...
    const handleSave = async () => {
      ...
      try {
        await db.collection("catches").doc(user.uid).collection("records").add(rec);
  ...
  /* ── DiaryScreen ── */
  function DiaryScreen({ user, onLogin, userLat, userLon }) {
    if (!user) return <RequireAuth user={user} onLogin={onLogin}><div/></RequireAuth>;
    ...
    const loadInitial = useCallback(()=>{
      ...
      const unsub = db.collection("catches").doc(user.uid).collection("records")
    ...
    const loadMore = async () => {
      ...
      setLoadingMore(true);
      const snap = await db.collection("catches").doc(user.uid).collection("records")
        .orderBy("createdAt","desc").startAfter(lastDocRef.current).limit(20).get();
    ...
    const exportCSV = useCallback(async()=>{
      const snap = await db.collection("catches").doc(user.uid).collection("records").orderBy("createdAt","desc").get();
      ...
      <div style={{display:"flex",flexDirection:"column",height:"100%"}}>
        ...
        <div style={{padding:"12px 14px 0",flexShrink:0}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:8,background:C.surfaceHi,borderRadius:12,padding:"8px 12px",border:`1px solid ${C.border}`,marginBottom:8}}>
            ...
            <input value={search} onChange={e=>setSearch(e.target.value)} placeholder="Поиск по рыбе, месту, заметкам..." style={{flex:1,background:"none",border:"none",outline:"none",color:C.text,fontSize:13}}/>
        ...
        <div style={{flex:1,overflowY:"auto",padding:"4px 14px 80px"}} onScroll={handleScroll}>
            ...
            <div style={{textAlign:"center",padding:"60px 20px",color:C.muted}}>
              ...
              {search||filterFish||filterGear||filterPeriod!=="all"?(
                <>
                  ...
                  <button onClick={()=>{setSearch("");setFilterFish("");setFilterGear("");setFilterPeriod("all");}} style={{padding:"8px 20px",borderRadius:12,border:`1px solid ${C.accent}`,background:C.accentDim,color:C.accent,fontSize:13,cursor:"pointer"}}>Сбросить фильтры</button>
                </>
              ):(
                <>
          ...
          {!loading&&filtered.map(rec=><CatchCard key={rec.id} record={rec} onClick={()=>setSelected(rec)} onDelete={async id=>{await db.collection("catches").doc(user.uid).collection("records").doc(id).delete();}}/>)}
  ...
  /* ── MapCombinedScreen — точки + магазины ── */
  function BasesScreen({ userLat, userLon }) {
    ...
    const pts = FISHING_BASES.map(b=>`${b.lon},${b.lat},${selected?.id===b.id?"pm2gnl1":"pm2blm1"}`).join("~");
    const mapSrc = `https://yandex.ru/map-widget/v1/?ll=${centerLon},${centerLat}&z=${zoom}&pt=${pts}&l=map`;
    ...
    return (
      <div style={{height:"100%",display:"flex",flexDirection:"column",background:C.bg,overflow:"hidden"}}>
        ...
        <div style={{flex:"0 0 42%",position:"relative",background:"#0a192f"}}>
          <iframe key="yandex-bases-map" src={mapSrc} style={{width:"100%",height:"100%",display:"block",border:"none"}} frameBorder="0" allowFullScreen loading="lazy"/>
          {selected&&(
  ...
  function MapCombinedScreen({ userLat, userLon, user }) {
    ...
    return (
      <div style={{display:"flex",flexDirection:"column",height:"100%"}}>
        ...
        <div style={{flex:1,overflow:"hidden"}}>
          {mapTab==="spots"&&<MapScreen userLat={userLat} userLon={userLon} user={user}/>}
  ...
  function ShopsScreen({ userLat, userLon }) {
    ...
    const fetchShops = async () => {
      ...
      setFetchErr(false);
      try {
        // Overpass API (OpenStreetMap) — fishing shops within 60 km
        ...
        // Use OSM data only if we got meaningful results; otherwise fall back to static list
    ...
    // Live Yandex Maps: search mode when no shop selected, pin mode when shop selected
    const mapSrc = selected
      ? `https://yandex.ru/map-widget/v1/?ll=${selected.lng},${selected.lat}&z=16&pt=${selected.lng},${selected.lat},pm2rdl1&l=map`
      : `https://yandex.ru/map-widget/v1/?text=${encodeURIComponent("рыболовный магазин")}&ll=${centerLon},${centerLat}&z=11&l=map`;
    ...
    return(
      <div style={{height:"100%",display:"flex",flexDirection:"column",background:C.bg,overflow:"hidden"}}>
        ...
        {/* Embedded map — shows live Yandex Maps data */}
        <div style={{flex:"0 0 44%",position:"relative",background:"#0a192f"}}>
          <iframe
            key="yandex-shops-map"
            src={mapSrc}
        ...
        {/* Bottom panel — shop list or shop detail */}
  ...
  function LeaderboardScreen({ onBack, user }) {
    ...
    useEffect(()=>{
      ...
      db.collection("leaderboard").doc(period).collection("rows").doc(user.uid).get()
    ...
    useEffect(()=>{
      ...
      if (period !== "all") {
        // Используем предварительно вычисленные данные из Cloud Function
        db.collection("leaderboard").doc(period).collection("rows")
    ...
    const computeFromReports = (period) => {
      let q = db.collection("reports").orderBy("timestamp","desc").limit(500);
      if(period==="week"){
        const since=new Date(); since.setDate(since.getDate()-7);
        q=db.collection("reports").where("timestamp",">=",firebase.firestore.Timestamp.fromDate(since)).orderBy("timestamp","desc").limit(500);
      ...
      q.get().then(snap=>{
        ...
        setRows(Object.values(map).sort((a,b)=>b.totalKg-a.totalKg||b.catches-a.catches).slice(0,50));
        setLoading(false);
  ...
  /* ── TournamentScreen ── */
  function TournamentScreen({ onBack, user }) {
    ...
    useEffect(()=>{
      ...
      const unsub=db.collection("tournaments").orderBy("startDate","asc")
        .onSnapshot(snap=>{ setTournaments(snap.docs.map(d=>({...d.data(),id:d.id}))); setLoading(false); },
        ()=>setLoading(false));
      return unsub;
    },[]);
    ...
    useEffect(()=>{
      ...
      Promise.all(tournaments.map(t=>
        db.collection("tournaments").doc(t.id).collection("participants").doc(user.uid).get()
    ...
    const register=async(tId)=>{
      ...
      try{
        await db.collection("tournaments").doc(tId).collection("participants").doc(user.uid).set({
          uid:user.uid,name:user.displayName||"Рыбак",registeredAt:firebase.firestore.FieldValue.serverTimestamp()
        });
  ...
  function App() {
    ...
    const onFabTouchEnd = useCallback((e)=>{
      ...
      if(fabDrag.current.moved){
        setFabPos(p=>{ const pos=p||{}; localStorage.setItem("eger_fab_pos",JSON.stringify(pos)); return pos; });
      } else {
        logEvent("catch_button_tapped"); setShowCatch(true);
      }
    },[]);

    useEffect(()=>{ const u=auth.onAuthStateChanged(u=>{setUser(u);setAuthLoading(false);}); return u; },[]);
    ...
    useEffect(()=>{
      const unsub=db.collection("water_levels").doc("don-rostov").onSnapshot(doc=>{ if(doc.exists) setWaterLevel(doc.data()); });
      return unsub;
    },[]);
    ...
    useEffect(()=>{
      ...
      navigator.geolocation.getCurrentPosition(
        pos => {
          ...
          // Перезагружаем погоду по реальной позиции
          (async()=>{
            setWeatherLoading(true);
            try { setWeather(await fetchWeather(lat, lon)); } catch(e){}
            setWeatherLoading(false);
          })();
          // Сохраняем геопозицию для Cloud Function near-catch уведомлений
          auth.currentUser && db.collection("users").doc(auth.currentUser.uid).set(
            {lat, lng:lon, geoAt:firebase.firestore.FieldValue.serverTimestamp()}, {merge:true}
          ).catch(()=>{});
        },
    ...
    // Запрос разрешения на уведомления — только для авторизованных, с задержкой
    useEffect(()=>{
      if(!user) return;
    ...
    useEffect(()=>{
      let first=true;
      const unsub=db.collection("messages").orderBy("timestamp","asc").limit(200)
        .onSnapshot(snap=>{
    ...
    return (
      <div style={{maxWidth:430,margin:"0 auto",height:"100dvh",display:"flex",flexDirection:"column",background:"linear-gradient(180deg,#07111e 0%,#0a192f 100%)",position:"relative",overflow:"hidden"}}>
        ...
        <main key={tab} style={{flex:1,overflow:"hidden",position:"relative",zIndex:1,animation:"fadeIn .2s ease"}}>
          ...
          {tab==="mapall"    && <MapCombinedScreen userLat={userLat} userLon={userLon} user={user}/>}
          {(tab==="spots"||tab==="map") && <MapCombinedScreen userLat={userLat} userLon={userLon} user={user}/>}
        ...
        <nav style={{display:"flex",background:"rgba(7,17,30,.95)",backdropFilter:"blur(24px)",borderTop:`1px solid ${C.border}`,paddingBottom:"env(safe-area-inset-bottom,6px)",position:"relative",zIndex:10}}>
          {NAV.map(({id,label,Icon})=>{
            const active=tab===id;
            const badge=id==="community"?unreadChat:id==="news"?unreadNews:0;
            return (
              <button key={id} onClick={()=>goTab(id)} style={{flex:1,padding:"8px 0 6px",background:"none",border:"none",cursor:"pointer",display:"flex",flexDirection:"column",alignItems:"center",gap:2,position:"relative"}}>
                ...
                <span style={{fontSize:9,letterSpacing:.3,fontWeight:active?700:500,color:active?C.accent:C.dimmer}}>{label}</span>
              </button>
            );
          })}
        </nav>
